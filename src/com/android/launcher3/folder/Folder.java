...
import app.mica.util.EditTextExtensions;
...
public class Folder extends AbstractFloatingView implements ClipPathView, DragSource,
    ...
    protected void onFinishInflate() {
        ...
        mBackground.setColor(MicaUtilsKt.resolveFolderBackgroundColor(getContext()));
        var alpha = MicaUtilsKt.getFolderBackgroundAlpha(getContext());
    ...
    /**
     * LC: App drawer folders live in Mica's own database and are not part of the
    ...
    public WindowInsets onApplyWindowInsets(WindowInsets windowInsets) {
        ...
        // Mica-TODO: Keyboard too close to Folder name edit?
