...
public class ActivityAllAppsContainerView<T extends Context & ActivityContext>
    ...
    protected void initContent() {
        ...
        if (Flags.enablePrivateSpace()) {
            mPrivateSpaceHeaderViewController = new PrivateSpaceHeaderViewController(mPrivateProfileManager);
        }
    ...
    protected void onFinishInflate() {
        ...
        mBottomSheetBackgroundColor = Themes.getAttrColor(getContext(), R.attr.materialColorSurfaceDim);
