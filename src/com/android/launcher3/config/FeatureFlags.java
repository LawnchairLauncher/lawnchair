...
public final class FeatureFlags {
        ...
        public static final BooleanFlag CUSTOM_LPNH_THRESHOLDS = getReleaseFlag(301680992, "CUSTOM_LPNH_THRESHOLDS",
                        DISABLED,
                        "Add dev options to customize the LPNH trigger slop and milliseconds");

        public static final BooleanFlag ANIMATE_LPNH = getReleaseFlag(308693847, "ANIMATE_LPNH", TEAMFOOD,
                        "Animates navbar when long pressing");

        public static final BooleanFlag SHRINK_NAV_HANDLE_ON_PRESS = getReleaseFlag(314158312,
                        "SHRINK_NAV_HANDLE_ON_PRESS", DISABLED,
                        "Shrinks navbar when long pressing if ANIMATE_LPNH is enabled");

        public static final IntFlag LPNH_SLOP_PERCENTAGE = getIntFlag(301680992, "LPNH_SLOP_PERCENTAGE", 100,
                        "Controls touch slop percentage for lpnh");

        public static final IntFlag LPNH_TIMEOUT_MS = getIntFlag(301680992, "LPNH_TIMEOUT_MS",
        ...
        public static final BooleanFlag ENABLE_LONG_PRESS_NAV_HANDLE = getReleaseFlag(299682306,
                        "ENABLE_LONG_PRESS_NAV_HANDLE", TEAMFOOD,
                        "Enables long pressing on the bottom bar nav handle to trigger events.");

        public static final BooleanFlag ENABLE_SEARCH_HAPTIC_HINT = getReleaseFlag(314005131,
                        "ENABLE_SEARCH_HAPTIC_HINT", ENABLED,
                        "Enables haptic hint while long pressing on the bottom bar nav handle.");

        public static final BooleanFlag ENABLE_SEARCH_HAPTIC_COMMIT = getReleaseFlag(314005577,
                        "ENABLE_SEARCH_HAPTIC_COMMIT", ENABLED,
                        "Enables haptic hint at end of long pressing on the bottom bar nav handle.");

        public static final IntFlag LPNH_HAPTIC_HINT_START_SCALE_PERCENT = getIntFlag(309972570,
                        "LPNH_HAPTIC_HINT_START_SCALE_PERCENT", 0,
                        "Haptic hint start scale.");

        public static final IntFlag LPNH_HAPTIC_HINT_END_SCALE_PERCENT = getIntFlag(309972570,
                        "LPNH_HAPTIC_HINT_END_SCALE_PERCENT", 100,
                        "Haptic hint end scale.");

        public static final IntFlag LPNH_HAPTIC_HINT_SCALE_EXPONENT = getIntFlag(309972570,
                        "LPNH_HAPTIC_HINT_SCALE_EXPONENT", 1,
                        "Haptic hint scale exponent.");

        public static final IntFlag LPNH_HAPTIC_HINT_ITERATIONS = getIntFlag(309972570, "LPNH_HAPTIC_HINT_ITERATIONS",
                        50,
                        "Haptic hint number of iterations.");

        public static final BooleanFlag ENABLE_LPNH_DEEP_PRESS = getReleaseFlag(310952290, "ENABLE_LPNH_DEEP_PRESS",
                        ENABLED,
                        "Long press of nav handle is instantly triggered if deep press is detected.");

        public static final IntFlag LPNH_HAPTIC_HINT_DELAY = getIntFlag(309972570, "LPNH_HAPTIC_HINT_DELAY", 0,
        ...
        // This is all to prevent merge conflicts in the future and help keep track of
        // who owns which
        // flags.
