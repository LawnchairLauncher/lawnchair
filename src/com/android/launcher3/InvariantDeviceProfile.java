...
public class InvariantDeviceProfile implements SafeCloseable {
        ...
        private InvariantDeviceProfile(Context context) {
                ...
                LockedUserState.get(context).runOnUserUnlocked(() -> new DeviceGridState(this).writeToPrefs(context));
        ...
        public InvariantDeviceProfile(Context context, Display display) {
                ...
                @DeviceType
                int defaultDeviceType = defaultInfo.getDeviceType();
                ...
                @DeviceType
                int deviceType = myInfo.getDeviceType();
        ...
        /**
         * @deprecated This is a temporary solution because on the backup and restore
         *             case we modify the
        ...
        private void initGrid(Context context, Info displayInfo, DisplayOption displayOption,
                ...
                numAllAppsRowsForCellHeightCalculation = closestProfile.mNumAllAppsRowsForCellHeightCalculation;
        ...
        /**
         * Returns the GridOption associated to the given file name or null if the
         * fileName is not
         * supported.
        ...
        /**
         * Returns the name of the given size on the current device or empty string if
         * the size is not
         * supported. Ej. 4x4 -> normal, 5x4 -> practical, etc.
         * (Note: the name of the grid can be different for the same grid size depending
         * of
        ...
        /**
         * Returns the grid option for the given gridName on the current device (Note:
         * the gridOption
         * be different for the same gridName depending on the values of the
        ...
        public int workspaceSpecsId = INVALID_RESOURCE_HANDLE;
                ...
                inlineNavButtonsEndSpacing=a.getResourceId(R.styleable.GridDisplayOption_inlineNavButtonsEndSpacing,R.dimen.taskbar_button_margin_default);

                numFolderRows[INDEX_DEFAULT]=a.getInt(R.styleable.GridDisplayOption_numFolderRows,numRows);numFolderColumns[INDEX_DEFAULT]=a.getInt(R.styleable.GridDisplayOption_numFolderColumns,numColumns);
                ...
                folderStyle=a.getResourceId(R.styleable.GridDisplayOption_folderStyle,INVALID_RESOURCE_HANDLE);
        ...
        public void setCurrentGrid(Context context, String gridName) {
                        ...
                        try (XmlResourceParser parser = context.getResources().getXml(R.xml.device_profiles)) {
                                ...
                                while (((type = parser.next()) != XmlPullParser.END_TAG ||
                                        ...
                                        if ((type == XmlPullParser.START_TAG)
                                                ...
                                                GridOption gridOption = new GridOption(context,
                                                                Xml.asAttributeSet(parser));
                                                if (gridOption.isEnabled(deviceType) || allowDisabledGrid) {
                                                        final int displayDepth = parser.getDepth();
                                                        while (((type = parser.next()) != XmlPullParser.END_TAG
                                                                ...
                                                                if ((type == XmlPullParser.START_TAG)
                                                                                && "display-option".equals(
                                                                                                parser.getName())) {
                                                                        profiles.add(new DisplayOption(gridOption,
                                                                                        context,
                                                                                        Xml.asAttributeSet(parser)));
                                                                }
                                                        }
                ...
                private void applyPartnerDeviceProfileOverrides(Context context, DisplayMetrics dm) {
                        ...
                        try {
                                ...
                                if (iconSizePx > 0) {
                                        this.iconSize[InvariantDeviceProfile.INDEX_DEFAULT] = Utilities
                ...
                private static DisplayOption invDistWeightedInterpolate(
                        ...
                        Collections.sort(points,
                                        (a, b) -> Float.compare(dist(width, height, a.minWidthDps, a.minHeightDps),
                                                        dist(width, height, b.minWidthDps, b.minHeightDps)));
        ...
        public DeviceProfile getBestMatch(float screenWidth, float screenHeight, int rotation) {
                ...
                public static final class GridOption {
                        ...
                        public GridOption(Context context, AttributeSet attrs) {
                                ...
                                numDatabaseHotseatIcons = a.getInt(
                                                R.styleable.GridDisplayOption_numExtendedHotseatIcons,
                                                2 * numHotseatIcons);
                                ...
                                if (FeatureFlags.ENABLE_RESPONSIVE_WORKSPACE.get()) {
                                        mWorkspaceSpecsId = a.getResourceId(
                                                        R.styleable.GridDisplayOption_workspaceSpecsId,
                                                        INVALID_RESOURCE_HANDLE);
                                        mWorkspaceSpecsTwoPanelId = a.getResourceId(
                                                        R.styleable.GridDisplayOption_workspaceSpecsTwoPanelId,
                                                        INVALID_RESOURCE_HANDLE);
                                        mAllAppsSpecsId = a.getResourceId(
                                                        R.styleable.GridDisplayOption_allAppsSpecsId,
                                                        INVALID_RESOURCE_HANDLE);
                                        mAllAppsSpecsTwoPanelId = a.getResourceId(
                                                        R.styleable.GridDisplayOption_allAppsSpecsTwoPanelId,
                                                        INVALID_RESOURCE_HANDLE);
                                        mFolderSpecsId = a.getResourceId(
                                                        R.styleable.GridDisplayOption_folderSpecsId,
                                                        INVALID_RESOURCE_HANDLE);
                                        mFolderSpecsTwoPanelId = a.getResourceId(
                                                        R.styleable.GridDisplayOption_folderSpecsTwoPanelId,
                                                        INVALID_RESOURCE_HANDLE);
                                        mHotseatSpecsId = a.getResourceId(
                                                        R.styleable.GridDisplayOption_hotseatSpecsId,
                                                        INVALID_RESOURCE_HANDLE);
                                        mHotseatSpecsTwoPanelId = a.getResourceId(
                                                        R.styleable.GridDisplayOption_hotseatSpecsTwoPanelId,
                                                        INVALID_RESOURCE_HANDLE);
                                ...
                                switch (deviceType) {
                                        case TYPE_PHONE:
                                                return (deviceCategory
                                                                & DEVICE_CATEGORY_PHONE) == DEVICE_CATEGORY_PHONE;
                                        case TYPE_TABLET:
                                                return (deviceCategory
                                                                & DEVICE_CATEGORY_TABLET) == DEVICE_CATEGORY_TABLET;
                ...
                static final class DisplayOption {
                        ...
                        DisplayOption(GridOption grid, Context context, AttributeSet attrs) {
                                ...
                                iconSizes[INDEX_DEFAULT] = a.getFloat(R.styleable.ProfileDisplayOption_iconImageSize,
                                                0);
                                ...
                                textSizes[INDEX_LANDSCAPE] = a.getFloat(
