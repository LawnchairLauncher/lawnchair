...
public class FloatingSurfaceView extends AbstractFloatingView implements
    ...
    protected void handleClose(boolean animate) {
        ...
        MAIN_EXECUTOR.getHandler().postDelayed(mRemoveViewRunnable,
    ...
    private void updateIconLocation() {
        ...
        if (iconChanged && !mIconBounds.isEmpty()) {
            ...
            if (mIcon instanceof BubbleTextView) {
                iconDrawable = ((BubbleTextView) mIcon).getIcon();
            }
    ...
    private void setCurrentIconVisible(boolean isVisible) {
        if (mIcon != null) {
            if (mIcon instanceof BubbleTextView) {
                ((BubbleTextView) mIcon).setIconVisible(isVisible);
                ((BubbleTextView) mIcon).forceHideDot(!isVisible);
            }
        }
    }
}
