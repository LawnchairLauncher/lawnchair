...
public class LauncherFiles {
    ...
    public static final String SHARED_PREFERENCES_KEY = "ch.deletescape.lawnchair.prefs";
    ...
    public static final String DEVICE_PREFERENCES_KEY = "ch.deletescape.lawnchair.device.prefs";
