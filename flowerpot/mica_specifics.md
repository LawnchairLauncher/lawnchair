...
If you want to manually add a rule to one of Mica's rulesets you can simply add it to one of the static templates in the `templates/` directory. Create one with a categories name if none exists yet.
