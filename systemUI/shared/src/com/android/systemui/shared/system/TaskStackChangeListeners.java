    ...
    private class Impl extends TaskStackListener implements Handler.Callback {
        ...
        public void addListener(TaskStackChangeListener listener) {
            ...
            if (!mRegistered) {
                ...
                try {
                    if (!MicaQuickstepCompat.ATLEAST_V) return;
                    ...
                    // pE-TODO(CompatTier2): Find a way to deal with MicaQuickstepCompat instead of NoClassDefFoundError | ExceptionInInitializerError catch
