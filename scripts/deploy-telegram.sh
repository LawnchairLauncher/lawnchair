...
cp app/build/outputs/mapping/release/mapping.txt proguard-$MAJOR_MINOR.$TRAVIS_BUILD_NUMBER_plah.txt
curl -F chat_id="152559768" -F document=@"proguard-$MAJOR_MINOR.$TRAVIS_BUILD_NUMBER_plah.txt" https://api.telegram.org/bot$BOT_TOKEN/sendDocument