...
UPLOADURL=$(python -c "import sys, json; print json.load($RESP1)['upload_url']") 
UPLOADID=$(python -c "import sys, json; print json.load($RESP1)['upload_id']")
...
RELEASEURL=$(python -c "import sys, json; print json.load($RESP2)['release_url']")
