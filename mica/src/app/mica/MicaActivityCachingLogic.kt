...
private const val TAG = "MicaActivityCachingLogic"

@LauncherAppSingleton
class MicaActivityCachingLogic @Inject constructor(
    ...
    companion object {
        @JvmField
        val INSTANCE = DaggerSingletonObject(LauncherAppComponent::getMicaActivityCachingLogic)
    }
}
