    ...
    companion object {
        ...
        fun resolveDefault(context: Context): QsbSearchProvider {
            ...
            val isDefaultProviderIntentResolved =
                MicaQsbLayout.resolveIntent(context, defaultProvider.createSearchIntent())
            ...
            return values()
                ...
                .firstOrNull { MicaQsbLayout.resolveIntent(context, it.createSearchIntent()) }
                ?: AppSearch
        }
    }
}
