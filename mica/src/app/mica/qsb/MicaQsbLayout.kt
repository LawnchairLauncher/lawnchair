...
import app.mica.qsb.providers.AppSearch
...
import app.mica.util.repeatOnAttached
...
class MicaQsbLayout(context: Context, attrs: AttributeSet?) : FrameLayout(context, attrs) {
    ...
    private fun openOptions() {
        ...
        OptionsPopupView.show<MicaLauncher>(launcher, RectF(pos), listOf(getCustomizeOption()), true)
    }
