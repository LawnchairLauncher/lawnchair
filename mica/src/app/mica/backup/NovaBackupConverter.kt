...
class NovaBackupConverter(
    ...
    suspend fun convertAndRestore(info: NovaBackupInfo) = withContext(Dispatchers.IO) {
        ...
        try {
            ...
            writeGridToMicaPrefs(info)

            val restoredDbFile = context.getDatabasePath(MicaBackup.RESTORED_DB_FILE_NAME)
    ...
    private fun writeGridToMicaPrefs(info: NovaBackupInfo) {
    ...
    private fun insertNovaItems(
        ...
        src.rawQuery(
            ...
            while (cursor.moveToNext()) {
                ...
                /* TODO: Mica folder synchronization support
                 *        For nova parity:
