...
import app.mica.MicaProto.BackupInfo
import app.mica.util.hasFlag
import app.mica.util.scaleDownTo
import app.mica.util.scaleDownToDisplaySize
...
class MicaBackup(
    ...
    companion object {
        ...
        fun generateBackupFileName(): String {
            val fileName = "Mica_Backup ${SimpleDateFormat.getDateTimeInstance().format(Date())}"
            return "$fileName.micabackup"
        }
        ...
        suspend fun create(context: Context, contents: Int, screenshotBitmap: Bitmap, fileUri: Uri) {
            ...
            val info = BackupInfo.newBuilder()
                .setMicaVersion(BuildConfig.VERSION_CODE)
