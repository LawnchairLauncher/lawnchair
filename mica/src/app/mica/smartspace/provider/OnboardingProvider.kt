package app.mica.smartspace.provider
...
import app.mica.smartspace.model.SmartspaceAction
import app.mica.smartspace.model.SmartspaceScores
import app.mica.smartspace.model.SmartspaceTarget
import app.mica.util.getApkVersionComparison
...
class OnboardingProvider(context: Context) :
    ...
    companion object {
        const val PREF_MICA_MAJOR_VERSION = "pref_micaMajorVersion"
    ...
    private fun hasRecentlyUpgradedMajor(): Boolean {
        return context.getApkVersionComparison().first[0] > prefs.getInt(PREF_MICA_MAJOR_VERSION, 123456)
    }
    ...
    private fun getSmartspaceTarget(): SmartspaceTarget? {
        return when {
            ...
            hasRecentlyUpgradedMajor() -> {
                ...
                prefs.edit { putInt(PREF_MICA_MAJOR_VERSION, context.getApkVersionComparison().first[0]) }
                SmartspaceTarget(
