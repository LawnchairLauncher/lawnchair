 ...
 * them to [MicaPredictionStore] depending on where the app is launched from.
 *
 ...
 * to [UsageStatsRanker], and target compilation to [MicaPredictionEngine].
 */
class MicaAppPredictor(private val context: Context) : StatsLogCompatManager.StatsLogConsumer {

    private val userCache = UserCache.INSTANCE.get(context)
    private val predictionManager = MicaPredictionManager.getInstance(context)
    ...
    private val predictionEngine = MicaPredictionEngine(context, usageStatsRanker)
