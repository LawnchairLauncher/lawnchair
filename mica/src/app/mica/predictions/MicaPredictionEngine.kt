...
class MicaPredictionEngine(
    ...
    private fun shouldUseWeightedUsageStats(): Boolean {
        if (!prefs2.micaPredictorUseWeightedUsageStats.firstCached()) return false
        ...
        return userProfilesInPredictionOrder()
            ...
            .flatMap { user ->
                try {
                    ...
                    Log.e("MicaPredictionEngine", "Failed to get activity list for user $user", e)
                    emptyList()
                }.asSequence()
            }
