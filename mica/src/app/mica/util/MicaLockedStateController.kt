...
object MicaLockedStateController {

    private const val TAG = "MicaLockedStateController"
    ...
    private val backgroundThread: HandlerThread by lazy {
        HandlerThread("Recents-MicaLockedStateController", 10)
    }
    ...
    fun initialize(context: Context): MicaLockedStateController {
