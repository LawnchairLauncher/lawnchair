package app.mica.search.adapter
...
import app.mica.allapps.views.SearchResultView
import app.mica.search.algorithms.data.Calculation
import app.mica.search.algorithms.data.ContactInfo
import app.mica.search.algorithms.data.FileInfo
import app.mica.search.algorithms.data.FileInfo.Companion.isImageType
import app.mica.search.algorithms.data.FolderInfo
import app.mica.search.algorithms.data.IFileInfo
import app.mica.search.algorithms.data.RecentKeyword
import app.mica.search.algorithms.data.SettingInfo
import app.mica.search.algorithms.engine.provider.web.WebSearchProvider
import app.mica.theme.color.tokens.ColorTokens
import app.mica.util.calculateInSampleSize
import app.mica.util.createFilePreviewFallbackBitmap
import app.mica.util.createSmallSearchResultBitmap
import app.mica.util.createTextBitmap
import app.mica.util.file2Uri
import app.mica.util.mimeCompat
