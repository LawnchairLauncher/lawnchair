package app.mica.search.algorithms
...
import app.mica.search.adapter.SearchLinksTarget
import app.mica.search.adapter.SearchTargetCompat
import app.mica.search.adapter.SearchTargetFactory
import app.mica.search.algorithms.engine.ActionsSectionBuilder
import app.mica.search.algorithms.engine.AppsAndShortcutsSectionBuilder
import app.mica.search.algorithms.engine.CalculationSectionBuilder
import app.mica.search.algorithms.engine.ContactsSectionBuilder
import app.mica.search.algorithms.engine.EmptyStateSectionBuilder
import app.mica.search.algorithms.engine.FilesSectionBuilder
import app.mica.search.algorithms.engine.HistorySectionBuilder
import app.mica.search.algorithms.engine.SearchProvider
import app.mica.search.algorithms.engine.SearchResult
import app.mica.search.algorithms.engine.SearchSettingsSectionBuilder
import app.mica.search.algorithms.engine.SectionBuilder
import app.mica.search.algorithms.engine.SettingsSectionBuilder
import app.mica.search.algorithms.engine.WebSuggestionsSectionBuilder
import app.mica.search.algorithms.engine.provider.CalculatorSearchProvider
import app.mica.search.algorithms.engine.provider.ContactsSearchProvider
import app.mica.search.algorithms.engine.provider.FileSearchProvider
import app.mica.search.algorithms.engine.provider.HistorySearchProvider
import app.mica.search.algorithms.engine.provider.SettingsSearchProvider
import app.mica.search.algorithms.engine.provider.ShortcutSearchProvider
import app.mica.search.algorithms.engine.provider.apps.AppSearchProvider
import app.mica.search.algorithms.engine.provider.web.CustomWebSearchProvider
import app.mica.search.algorithms.engine.provider.web.WebSuggestionProvider
...
class MicaLocalSearchAlgorithm(context: Context) : MicaSearchAlgorithm(context) {
