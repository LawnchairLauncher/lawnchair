...
import app.mica.ui.preferences.destinations.ShapeRoute
import kotlinx.serialization.Serializable

private const val URI = "mica://settings"

/**
 * Represents a route in the Mica preferences navigation graph.
 *
...
@Serializable
data object PrivacyPolicy : PreferenceRoute, PreferenceDeepLink {
    override val deepLink = "$URI/privacy-policy"
}
