package app.mica.ui.preferences.navigation
...
import app.mica.backup.ui.CreateBackupScreen
import app.mica.backup.ui.restoreBackupGraph
import app.mica.backup.ui.restoreNovaBackupGraph
...
import app.mica.ui.preferences.about.About
import app.mica.ui.preferences.about.PrivacyPolicyScreen
import app.mica.ui.preferences.about.acknowledgements.Acknowledgements
import app.mica.ui.preferences.components.colorpreference.ColorPreferenceModelList
import app.mica.ui.preferences.components.colorpreference.ColorSelection
import app.mica.ui.preferences.components.search.SearchProviderId
import app.mica.ui.preferences.components.search.SearchProviderPreferenceScreen
import app.mica.ui.preferences.destinations.AppDrawerFoldersPreference
import app.mica.ui.preferences.destinations.AppDrawerPreferences
import app.mica.ui.preferences.destinations.BackupAndRestorePreference
import app.mica.ui.preferences.destinations.CustomIconShapePreference
import app.mica.ui.preferences.destinations.DebugMenuPreferences
import app.mica.ui.preferences.destinations.DismissedPredictionAppsPreferences
import app.mica.ui.preferences.destinations.DockPreferences
import app.mica.ui.preferences.destinations.DummyPreference
import app.mica.ui.preferences.destinations.ExperimentalFeaturesPreferences
import app.mica.ui.preferences.destinations.FeatureFlagsPreference
import app.mica.ui.preferences.destinations.FolderPreferences
import app.mica.ui.preferences.destinations.FontSelection
import app.mica.ui.preferences.destinations.GeneralPreferences
import app.mica.ui.preferences.destinations.GesturePreferences
import app.mica.ui.preferences.destinations.HiddenAppsPreferences
import app.mica.ui.preferences.destinations.HomeScreenGridPreferences
import app.mica.ui.preferences.destinations.HomeScreenPreferences
import app.mica.ui.preferences.destinations.IconPackPreferences
import app.mica.ui.preferences.destinations.IconPickerPreference
import app.mica.ui.preferences.destinations.LauncherPopupPreference
import app.mica.ui.preferences.destinations.PickAppForGesture
import app.mica.ui.preferences.destinations.PredictionsPreferences
import app.mica.ui.preferences.destinations.PreferencesDashboard
import app.mica.ui.preferences.destinations.QuickstepPreferences
import app.mica.ui.preferences.destinations.SearchPreferences
import app.mica.ui.preferences.destinations.SearchProviderPreferences
import app.mica.ui.preferences.destinations.SelectAppsForDrawerFolder
import app.mica.ui.preferences.destinations.SelectIconPreference
import app.mica.ui.preferences.destinations.ShapePreference
import app.mica.ui.preferences.destinations.SmartspacePreferences
...
fun PreferenceNavigation(
    ...
    NavHost(
        ...
        composable<PrivacyPolicy>(
            deepLinks = getDeepLink(PrivacyPolicy),
        ) { PrivacyPolicyScreen() }
