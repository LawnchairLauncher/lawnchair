...
import app.mica.ui.preferences.components.controls.TextPreference
...
import app.mica.ui.preferences.navigation.FeatureFlags
    ...
    PreferenceLayout(
        ...
        MainSwitchPreference(adapter = enableDebug, label = "Show debug menu") {
                    ...
                    onClick = {
                        try {
                            ...
                            /* This is really unlikely, we are just highlighting the option,
                                not directly opening like Mica 14 and older unless they
            ...
            PreferenceGroup(heading = "Debug flags") {
                ...
                // Codename for Mica to intentionally omit version number from the public,
