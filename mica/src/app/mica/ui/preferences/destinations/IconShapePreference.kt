...
import app.mica.ui.preferences.components.layout.TwoTabPreferenceLayout
import app.mica.ui.preferences.navigation.GeneralCustomIconShapeCreator
...
fun iconShapeEntries(context: Context): List<ListPreferenceEntry<IconShape>> {
    ...
    return listOf(
        // Organized as seen in /mica/res/values/strings.xml
