...
import app.mica.predictions.MicaPredictor
import app.mica.predictions.NoPredictor
import app.mica.predictions.PredictionMode
import app.mica.predictions.SystemPredictor
...
import app.mica.ui.preferences.components.PermissionDialog
...
import app.mica.ui.preferences.navigation.DismissedPredictionApps
import app.mica.util.lifecycleState
...
private fun AppPredictionsFeature(
    ...
    val weightedUsageStatsAdapter = prefs2.micaPredictorUseWeightedUsageStats.getAdapter()
    ...
    PreferenceGroup(
        ...
        when (predictionModeAdapter.state.value) {
            ...
            MicaPredictor -> MicaPredictionSettings(
...
@Composable
private fun MicaPredictionSettings(
...
private fun rememberDismissedPredictionAppsCount(context: Context): Int {
    val dismissedAppsStore = remember {
        MicaPredictionManager.getInstance(context).dismissedAppsStore
    }
