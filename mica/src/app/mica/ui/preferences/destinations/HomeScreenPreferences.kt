...
import app.mica.ui.preferences.components.FeedPreference
import app.mica.ui.preferences.components.GestureHandlerPreference
import app.mica.ui.preferences.components.HomeLayoutSettings
import app.mica.ui.preferences.components.NavigationActionPreference
import app.mica.ui.preferences.components.OverlayHandlerPreference
...
import app.mica.ui.preferences.navigation.HomeScreenGrid
import app.mica.util.collectAsStateBlocking
...
fun HomeScreenPreferences(
    ...
    PreferenceLayout(
        ...
        PreferenceGroup(heading = stringResource(id = R.string.status_bar_label)) {
            ...
            ExpandAndShrink(visible = showStatusBarAdapter.state.value && MicaApp.isRecentsEnabled) {
                SwitchPreference(
