...
import app.mica.smartspace.SmartspaceViewContainer
...
import app.mica.smartspace.model.Smartspacer
...
fun SmartspacePreferences(
    ...
    val modeIsMica = selectedMode == MicaSmartspace
    ...
    PreferenceLayout(
        ...
        if (fromWidget) {
            SmartspacePreview()
            MicaSmartspaceSettings(smartspaceProvider)
        } else {
            MainSwitchPreference(
                adapter = smartspaceAdapter,
                label = stringResource(R.string.smartspace_widget_toggle_label),
                description = stringResource(id = R.string.smartspace_widget_toggle_description).takeIf { modeIsMica },
            ) {
                if (modeIsMica) {
                    SmartspacePreview()
                }
...
@Composable
private fun MicaSmartspaceSettings(
