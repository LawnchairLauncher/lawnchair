...
import app.mica.ui.preferences.components.QuickActionsPreferences
import app.mica.ui.preferences.components.RecentsQuickAction
...
import app.mica.util.isOnePlusStock
...
fun QuickstepPreferences(
    ...
    PreferenceLayout(
        ...
        if (!MicaApp.isRecentsEnabled) QuickSwitchIgnoredWarning()
