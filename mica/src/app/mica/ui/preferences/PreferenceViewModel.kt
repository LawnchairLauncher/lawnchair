...
import app.mica.ui.preferences.destinations.IconPackInfo
import app.mica.util.Constants.LAWNICONS_PACKAGE_NAME
import app.mica.util.getPackageVersionCode
...
class PreferenceViewModel(private val app: Application) :
    ...
    override val iconPacks = flow {
        ...
        val micaIcon = CustomAdaptiveIconDrawable.wrapNonNull(
