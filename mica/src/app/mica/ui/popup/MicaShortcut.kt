...
import app.mica.override.CustomizeAppDialog
...
import app.mica.ui.preferences.navigation.AppDrawerAppListToFolder
...
class MicaShortcut {
    ...
    companion object {
        ...
        fun showAppDrawerFolderPopup(
            ...
            // MicaFolderShortcut.kt
            return OptionsPopupView.show<MicaLauncher>(
                launcher,
                RectF(bounds),
                listOf(
        ...
        val CUSTOMIZE =
            SystemShortcut.Factory { activity: MicaLauncher, itemInfo, originalView ->
        ...
        private fun getAppInfo(launcher: MicaLauncher, itemInfo: ItemInfo): ModelAppInfo? {
        ...
        val PAUSE_APPS = SystemShortcut.Factory { activity: MicaLauncher, itemInfo: ItemInfo, originalView: View ->
    ...
    class Customize(
        private val launcher: MicaLauncher,
        private val appInfo: ModelAppInfo,
        itemInfo: ItemInfo,
        originalView: View,
    ) : SystemShortcut<MicaLauncher>(R.drawable.ic_edit, R.string.action_customize, launcher, itemInfo, originalView) {
            ...
            AlertDialog.Builder(context)
                ...
                .setPositiveButton(R.string.pause) { _, _ ->
                    try {
                        ...
                        Log.e("MicaShortcut", "Failed to pause app", e)
                    }
                }
                .show()
