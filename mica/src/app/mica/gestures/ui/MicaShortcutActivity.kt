...
class MicaShortcutActivity : ComponentActivity() {
    ...
    companion object {
        const val START_ACTION = "app.mica.START_ACTION"
        const val EXTRA_HANDLER = "app.mica.EXTRA_HANDLER"
        const val EXTRA_RESULT_RECEIVER = "app.mica.EXTRA_RESULT_RECEIVER"
