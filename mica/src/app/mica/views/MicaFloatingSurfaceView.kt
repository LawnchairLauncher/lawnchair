...
class MicaFloatingSurfaceView @JvmOverloads constructor(
    context: Context?,
    ...
    private val mLauncher: MicaLauncher = context!!.launcher
    ...
    private fun getBackgroundAnimator(): ObjectAnimator {
        ...
        val targetDepth = mLauncher.stateManager.state.getDepth<MicaLauncher?>(mLauncher)
    ...
    companion object {
         ...
         */
        fun show(launcher: MicaLauncher, contract: GestureNavContract?) {
            val view: MicaFloatingSurfaceView =
