...
import app.mica.data.Converters
...
import app.mica.icons.shape.IconShape
import app.mica.icons.shape.IconShapeManager
import app.mica.predictions.PredictionMode
import app.mica.preferences.PreferenceManager as MicaPreferenceManager
import app.mica.qsb.providers.QsbSearchProvider
import app.mica.search.algorithms.MicaSearchAlgorithm
import app.mica.search.algorithms.engine.provider.web.WebSearchProvider
import app.mica.smartspace.model.SmartspaceCalendar
import app.mica.smartspace.model.SmartspaceMode
import app.mica.smartspace.model.SmartspaceTimeFormat
import app.mica.theme.color.ColorMode
import app.mica.theme.color.ColorOption
import app.mica.theme.color.ColorStyle
import app.mica.ui.popup.LauncherOptionsPopup
import app.mica.ui.popup.toOptionOrderString
import app.mica.ui.preferences.components.HiddenAppsInSearch
import app.mica.ui.preferences.data.liveinfo.LiveInformationManager
import app.mica.util.kotlinxJson
import app.mica.views.overlay.FullScreenOverlayMode
...
class PreferenceManager2 @Inject constructor(
    ...
    val micaPredictorUseWeightedUsageStats = preference(
        key = booleanPreferencesKey(name = "mica_prediction_use_weighted_usage"),
        defaultValue = false,
    )
    ...
    val searchAlgorithm = preference(
        ...
        defaultValue = MicaSearchAlgorithm.LOCAL_SEARCH,
        onSet = { reloadHelper.recreate() },
    )
    ...
    val enableFontSelection = preference(
        ...
        onSet = { newValue ->
            if (!newValue) {
                ...
                MicaPreferenceManager.getInstance(context).fontWorkspace.set(newValue = fontCache.uiText)
            }
        },
    )
