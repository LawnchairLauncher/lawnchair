...
class MicaBugReporter(private val context: Context) {
    ...
    inner class Report(val error: String, val throwable: Throwable? = null) {
        ...
        private fun writeContents() = StringBuilder()
            ...
            .appendLine("isRecentsEnabled: ${MicaApp.isRecentsEnabled}")
            .appendLine()
    ...
    companion object {
        val INSTANCE = MainThreadInitializedObject(::MicaBugReporter)
    }
}
