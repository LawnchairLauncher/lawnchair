...
import app.mica.icons.picker.IconEntry
import app.mica.icons.picker.IconType
import app.mica.preferences.PreferenceManager
import app.mica.util.MultiSafeCloseable
...
class MicaIconProvider @Inject constructor(
    ...
    override fun getThemedIconMap(): MutableMap<String, ThemeData> {
        ...
        // first, get Mica's internal grayscale icon map
    ...
    companion object {
        const val TAG = "MicaIconProvider"
    }
}
