...
import app.mica.icons.shape.PathShapeDelegate
import app.mica.preferences.PreferenceChangeListener
...
constructor(
    ...
    init {
        val scope = MainScope() + CoroutineName("MicaThemeManager")
        merge(
...
private const val TAG = "MicaThemeManager"
