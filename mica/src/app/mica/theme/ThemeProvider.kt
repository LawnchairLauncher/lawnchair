...
import app.mica.theme.color.AndroidColor
import app.mica.theme.color.ColorOption
import app.mica.theme.color.ColorStyle
import app.mica.theme.color.MonetColorSchemeCompat
import app.mica.theme.color.SystemColorScheme
import app.mica.ui.theme.getSystemAccent
...
class ThemeProvider @Inject constructor(
    ...
    val colorScheme get() = when (val accentColor = this.accentColor) {
        ...
        is ColorOption.WallpaperPrimary -> {
            ...
            getColorScheme(wallpaperPrimary ?: ColorOption.MicaBlue.color, colorStyle.style)
        }

        is ColorOption.CustomColor -> getColorScheme(accentColor.color, colorStyle.style)

        else -> getColorScheme(ColorOption.MicaBlue.color, colorStyle.style)
    }
