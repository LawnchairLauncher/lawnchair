package app.mica.theme.color

import android.graphics.Color
import androidx.compose.ui.res.stringResource
import app.mica.ui.preferences.components.colorpreference.ColorPreferenceEntry
...
sealed class ColorOption {
    ...
    object Default : ColorOption() {
        ...
        override val colorPreferenceEntry = ColorPreferenceEntry<ColorOption>(
            this,
            { stringResource(id = R.string.managed_by_mica) },
            { 0 },
        )
    ...
    companion object {
        val MicaBlue = CustomColor(0xFF007FFF)
