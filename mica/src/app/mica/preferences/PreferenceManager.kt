...
import app.mica.util.isGestureNavContractCompatible
...
class PreferenceManager @Inject constructor(
    ...
    private val recreate = {
        MicaLauncher.instance?.recreateIfNotScheduled()
        Unit
    }
    ...
    val micaMajorVersion = IntPref(
        "pref_micaMajorVersion",
