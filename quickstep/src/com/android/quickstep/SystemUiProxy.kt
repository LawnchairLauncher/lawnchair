...
class SystemUiProxy(private val context: Context) {
    ...
    fun animateNavBarLongPress(isTouchDown: Boolean, durationMs: Long) {
        tryOrLog("Failed call animateNavBarLongPress") {
            systemUiProxy?.animateNavBarLongPress(isTouchDown, durationMs)
        }
    }
    ...
    private fun setupTransactionQueue() {
        ...
        shellTransitions?.apply {
            tryOrLog("Error getting Shell's apply token") {
                this.shellApplyToken?.apply {
