...
public class TaskbarUnstashInputConsumer extends DelegateInputConsumer {
    ...
    public void onMotionEvent(MotionEvent ev) {
        if (mState != STATE_ACTIVE) {
            ...
            if (!isStashedTaskbarHovered) {
                // if we're moving in the bubble bar area but we haven't passed the slop yet,
                // don't
                // propagate to the delegate, until we can determine the direction of the
                // gesture.
            ...
            // we're also active and there's no need to delegate any additional motion
            // events. the
