...
public class TaskView extends FrameLayout implements Reusable {
    ...
    public void setBorderEnabled(boolean enabled) {
        ...
        // Set the animation correctly in case it misses the hover/focus event during
        // state
        // transition
    ...
    public void draw(Canvas canvas) {
        // Draw border first so any child views outside of the thumbnail bounds are
        // drawn above it.
        if (mFocusBorderAnimator != null) {
    ...
    private ActivityOptions makeCustomAnimation(Context context, int enterResId,
        ...
        if (Utilities.ATLEAST_Q) {
            return LawnchairQuickstepCompat.getActivityOptionsCompat().makeCustomAnimation(context, enterResId,
                    exitResId, callbackHandler, callback, null);
        }
    ...
    protected void resetPersistentViewTransforms() {
        mNonGridTranslationX = mGridTranslationX = mGridTranslationY = mBoxTranslationY = mNonGridPivotTranslationX = 0f;
        resetViewTransforms();
    }
    ...
    private void applyScale() {
        /*
         * This is now only for grid mode on tablets. Unconditionally calling this
         * breaks
