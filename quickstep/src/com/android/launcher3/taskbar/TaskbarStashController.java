...
public class TaskbarStashController implements TaskbarControllers.LoggableTaskbarController {
    ...
    public void init(
        ...
        boolean isStashedInAppAuto = isTransientTaskbar && !mTaskbarSharedState.getTaskbarWasPinned();
     ...
     *
     * <p>
     * Do not stash if in small screen, with 3 button nav, and in landscape (or
     * seascape).
     * <p>
