...
public class TaskbarActivityContext extends BaseTaskbarContext {
    ...
    private WindowManager.LayoutParams createAllWindowParams() {
        ...
        // Provide WM layout params for all rotations to cache, see
        // NavigationBar#getBarLayoutParams
    ...
    /**
     * Updates the TaskbarContainer height (pass
     * {@link #getDefaultTaskbarWindowHeight()} to reset).
     */
    ...
    /**
     * Returns the default height of the window, including the static corner radii
     * above taskbar.
     */
