...
import app.lawnchair.theme.tokens.ColorToken
...
data class ResourceDrawableToken<T : Drawable>(@DrawableRes private val resId: Int) : DrawableToken<T> {
    ...
    override fun resolve(context: Context, scheme: TonalPalette, uiColorMode: UiColorMode): T {
...
data class MutatedDrawableToken<T : Drawable>(
    ...
    private val mutateBlock: T.(context: Context, scheme: TonalPalette, uiColorMode: UiColorMode) -> Unit,
) : DrawableToken<T> {
...
data class NewDrawable<T : Drawable>(
    private val factory: (context: Context, scheme: TonalPalette, uiColorMode: UiColorMode) -> T,
) : DrawableToken<T> {
...
fun <T : Drawable> DrawableToken<T>.mutate(
    mutateBlock: T.(context: Context, scheme: TonalPalette, uiColorMode: UiColorMode) -> Unit,
