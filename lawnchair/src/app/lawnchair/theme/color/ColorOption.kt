...
import app.lawnchair.ui.preferences.components.ColorPreferenceOption
...
sealed class ColorOption {
    ...
    abstract val preferenceOption: ColorPreferenceOption<ColorOption>

    object SystemAccent : ColorOption() {
        override val isSupported = true

        override val preferenceOption = ColorPreferenceOption<ColorOption>(
            this,
