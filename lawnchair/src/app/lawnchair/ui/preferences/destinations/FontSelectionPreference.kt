...
fun FontSelection(
    ...
    val items by produceState(initialValue = emptyList<FontCache.Family>()) {
        ...
        interVariants["regular"] = FontCache.ResourceFont(context, R.font.inter_regular, "Inter v3 Regular")
        interVariants["500"] = FontCache.ResourceFont(context, R.font.inter_medium, "Inter v3 Medium")
        interVariants["600"] = FontCache.ResourceFont(context, R.font.inter_semi_bold, "Inter v3 Semi Bold")
        interVariants["700"] = FontCache.ResourceFont(context, R.font.inter_bold, "Inter v3 Bold")
