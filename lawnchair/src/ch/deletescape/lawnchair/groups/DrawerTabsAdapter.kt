...
open class DrawerTabsAdapter(context: Context) :
    ...
    override fun createGroup(callback: (DrawerTabs.Tab, Boolean) -> Unit) {
        DrawerTabTypeSelectionBottomSheet.show(context, mapOf(
                FlowerpotTabs.TYPE_FLOWERPOT to arrayOf(R.string.tab_type_smart,
                                                        R.string.pref_appcategorization_flowerpot_summary,
                                                        R.drawable.ic_category),
                DrawerTabs.TYPE_CUSTOM to arrayOf(R.string.tab_type_custom,
                                                  R.string.tab_type_custom_desc, R.drawable.ic_list)
                                                             )) {
            when (it) {
