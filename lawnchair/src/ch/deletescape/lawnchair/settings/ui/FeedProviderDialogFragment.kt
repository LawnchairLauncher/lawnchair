...
class FeedProviderDialogFragment : PreferenceDialogFragmentCompat() {
    ...
    override fun onBindDialogView(view: View) {
        ...
        list.adapter = FeedProviderAdapter(context!!, FeedProviderPreference.providers(context!!),
                                           context!!.lawnchairPrefs.feedProvider) {
    ...
    inner class FeedProviderAdapter(context: Context,
                                    val providers: List<FeedProviderPreference.ProviderInfo>,
                                    private val selected: String,
                                    private val onSelect: (String) -> Unit) :
            ArrayAdapter<FeedProviderPreference.ProviderInfo>(context,
