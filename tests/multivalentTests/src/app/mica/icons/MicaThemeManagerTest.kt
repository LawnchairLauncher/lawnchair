...
class MicaThemeManagerTest {
    ...
    @Before
    fun setUp() {
        context.initDaggerComponent(DaggerMicaThemeManagerTestComponent.builder())
...
interface MicaThemeManagerTestComponent : LauncherAppComponent {
    ...
    interface Builder : LauncherAppComponent.Builder {
        ...
        override fun build(): MicaThemeManagerTestComponent
    }
}
