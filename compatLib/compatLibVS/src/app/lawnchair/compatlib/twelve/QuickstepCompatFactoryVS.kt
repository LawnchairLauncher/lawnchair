...
open class QuickstepCompatFactoryVS : QuickstepCompatFactory() {
    ...
    // TODO remove this as it's causing glitches on the first launch opening/closing app
    private fun createRemoteTransition(
        ...
        try {
            ...
            val constructor = remoteTransitionClass.getDeclaredConstructor(
                IRemoteTransition::class.java,
