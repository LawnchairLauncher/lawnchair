...
/** A fake implementation of [WidgetUsersRepository] for testing */
class FakeWidgetUsersRepository : WidgetUsersRepository {
    private val _userProfiles = MutableStateFlow<WidgetUserProfiles?>(null)
    private var workProfileUser: UserHandle? = null

    fun seedUserProfiles(profiles: WidgetUserProfiles?, workProfileUser: UserHandle?) {
        this.workProfileUser = workProfileUser
        _userProfiles.update { profiles }
    }

    override fun initialize() {}

    override fun observeUserProfiles(): Flow<WidgetUserProfiles?> = _userProfiles

    override fun getWorkProfileUser(): UserHandle? = workProfileUser

    override fun cleanUp() {
        _userProfiles.update { null }
