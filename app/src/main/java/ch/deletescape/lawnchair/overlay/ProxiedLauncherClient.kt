...
class ProxiedLauncherClient(private val launcher: Launcher) : ILauncherClient {
    ...
    private inner class ProxyCallbacks : ILauncherClientProxyCallback.Stub(), Handler.Callback {
        private var mClient: ProxiedLauncherClient? = null
        ...
        fun setClient(client: ProxiedLauncherClient) {
            mClient = client
    ...
    companion object {
        const val PROXY_PACKAGE = "ch.deletescape.lawnchair.launcherclientproxy"
        const val TAG = "ProxiedLauncherClient"
        ...
        fun getServiceIntent(): Intent = Intent().apply {
            component = ComponentName(PROXY_PACKAGE, "$PROXY_PACKAGE.LauncherClientProxyService")
